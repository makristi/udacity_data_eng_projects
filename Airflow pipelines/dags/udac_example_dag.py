...
run_quality_checks = DataQualityOperator(
    ...
    redshift_conn_id="redshift",
    data_checks=[
        {'sql_stmt': "SELECT COUNT(*) FROM users WHERE userid is null", 'expected_value': 0},
        {'sql_stmt': "SELECT COUNT(*) FROM songs WHERE songid is null", 'expected_value': 0},
        {'sql_stmt': "SELECT COUNT(*) FROM artists WHERE artistid is null", 'expected_value': 0},
        {'sql_stmt': "SELECT COUNT(*) FROM time WHERE start_time is null", 'expected_value': 0},
        {'sql_stmt': "SELECT COUNT(*) FROM songplays WHERE playid is null", 'expected_value': 0},
    ]
)
